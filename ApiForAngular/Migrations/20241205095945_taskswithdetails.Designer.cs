...
namespace ApiForAngular.Migrations
{
    ...
    [Migration("20241205095945_taskswithdetails")]
    partial class taskswithdetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiForAngular.ApplicationDbContext.ApplicationROle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ApiForAngular.ApplicationDbContext.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApiForAngular.Models.ClientLocations", b =>
                {
            ...
            modelBuilder.Entity("ApiForAngular.Models.Country", b =>
                {
                    b.Property<int>("CountryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiForAngular.Models.Project", b =>
                {
            ...
            modelBuilder.Entity("ApiForAngular.Models.TaskPriority", b =>
                {
            ...
            modelBuilder.Entity("ApiForAngular.Models.TaskStatusDetail", b =>
                {
            ...
            modelBuilder.Entity("ApiForAngular.Models.TaskStatuses", b =>
                {
                    b.Property<int>("TaskStatusID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiForAngular.Models.Tasks", b =>
                {
                    b.Property<int>("TaskID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiForAngular.Models.Project", b =>
                {
                    b.HasOne("ApiForAngular.Models.ClientLocations", "ClientLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiForAngular.Models.TaskStatusDetail", b =>
                {
                    b.HasOne("ApiForAngular.Models.Tasks", null)
                        .WithMany("TaskStatusDetails")
                        .HasForeignKey("TasksTaskID");

                    b.HasOne("ApiForAngular.ApplicationDbContext.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiForAngular.Models.Tasks", b =>
                {
                    b.HasOne("ApiForAngular.ApplicationDbContext.ApplicationUser", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedTo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ApiForAngular.ApplicationDbContext.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ApiForAngular.Models.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiForAngular.Models.TaskPriority", "TaskPriority")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("ApiForAngular.ApplicationDbContext.ApplicationROle", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ApiForAngular.ApplicationDbContext.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
